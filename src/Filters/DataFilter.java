...
public class DataFilter {
    ...
    private class Finder {
        ...
        private void createDataList(PixelMap map) throws BrokenImage {
            ...
            tess4J.processImage(xLine, yLine, map, img, dirName);
                ...
                for (int y = zeroPixel.getY() - 1; y > 0; --y)
                        ...
                        if (mas[y][x].equals(bl, 150)) {
                            ...
                            dataList.addLast(new Pair<>((hour++) % 24,
                                    Double.parseDouble(String.format("%.4f", tess4J.getValue(mas[y][x], dirName)).replace(",", "."))));
                            dataCount += 1;
                            break;
                        }
            }
    ...
    public LinkedList< Pair<Integer,Double> > getData(PixelMap map, BufferedImage img, String dirName) throws BrokenImage {
        this.img = img;
